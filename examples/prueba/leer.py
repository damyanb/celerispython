...
with open('C:/Users/Catolic Damyan/Downloads/CelerisPython/prueba/setup/config.json', 'r') as f:
    config = json.load(f)
...
# Cargar batimetría
bathy_data = np.loadtxt('C:/Users/Catolic Damyan/Downloads/CelerisPython/prueba/setup/bathy.txt')
